...
val add_counter_guard: site -> counter_guard -> ?directives:directive list -> remanent_state -> counter_guard_id * remanent_state
val add_counter_delta: site -> counter_delta -> ?directives:directive list -> remanent_state -> counter_delta_id * remanent_state
